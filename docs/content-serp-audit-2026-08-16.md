...
The only protected title above that depends on a current tax-year fact is the ₹12 lakh new-regime article. On 16 August 2026, the Income Tax Department's AY 2026-27 guidance states that the Section 87A rebate under the new regime is up to ₹60,000 where taxable income does not exceed ₹12,00,000. The title itself does not add a new rate; it only references the rebate and marginal-relief topic already present in the article.

Primary source checked:
- Income Tax Department — File ITR-2 Online / AY 2026-27 guidance: https://www.incometax.gov.in/iec/foportal/help/all-topics/e-filing-services/file-itr-2-online
