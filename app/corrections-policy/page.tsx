    ...
    <div className="mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="mt-6 overflow-x-auto">
        <table className="w-full min-w-[36rem] border-collapse text-left text-sm">
          <thead>
            <tr className="border-b border-brandBorder">
              <th className="py-3 pr-4 font-bold text-brandDeepNavy">
                Type of error
              </th>
              <th className="py-3 pr-4 font-bold text-brandDeepNavy">
                Examples
              </th>
              <th className="py-3 font-bold text-brandDeepNavy">
                How we handle it
              </th>
            </tr>
          </thead>
          <tbody>
            {severityTiers.map((row) => (
              <tr
                key={row.tier}
                className="border-b border-brandBorder align-top"
              >
                <td className="py-3 pr-4 font-semibold text-brandText">
                  {row.tier}
                </td>
                <td className="py-3 pr-4 leading-6 text-brandMuted">
                  {row.examples}
                </td>
                <td className="py-3 leading-6 text-brandMuted">
                  {row.response}
                </td>
              </tr>
            ))}
