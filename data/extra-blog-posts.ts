...
export const extraBlogPosts: BlogPost[] = [
  {
    ...
    officialSources: [
      {
        ...
        href: 'https://fcraonline.gov.in/',
      },
      {
        label: 'PIB — FCRA 2.0 Portal Launch, 30 June 2026',
        href: 'https://www.pib.gov.in/PressReleasePage.aspx?PRID=2279410&reg=48&lang=2',
      },
      {
        label: 'PIB — FCRA Backgrounder and 2026 Changes',
        href: 'https://www.pib.gov.in/PressReleasePage.aspx?PRID=2287897&lang=1&reg=3',
      },
      {
        label: 'Official Gazette — FCRA Amendment Rules, 2026',
        href: 'https://fcraonline.nic.in/home/PDF_Doc/fc_gaz_23062026.pdf',
      },
      {
    ...
    sections: [
      ...
      {
        title: 'Who usually needs FCRA registration or prior permission?',
        paragraphs: [
      ...
      {
        title: 'Big 2026 change: registration is purpose-specific and State-specific',
        paragraphs: [
        ...
        example: {
          title: 'Approved geography matters',
          details: 'An organisation approved for maternal healthcare in West Bengal and Odisha should not assume that the same foreign funds can immediately be used for an unrelated education campaign in Maharashtra. It should first check whether its approved purposes and geographical coverage allow that activity and seek the required change where necessary.',
        },
      },
      {
        title: 'Wider meaning of key functionary',
        paragraphs: [
      ...
      {
        title: 'Renewal now includes a minimum-utilisation test',
        paragraphs: [
        ...
        example: {
          title: 'A dormant registration',
          details: 'An association has a valid certificate but used only Rs 3 lakh of foreign contribution in the previous two years. It should not assume that renewal will be automatic. The minimum-utilisation rule and any applicable exception or official clarification must be checked before filing.',
        },
      },
      {
        title: 'Annual reporting is becoming much more detailed',
        paragraphs: [
        ...
        example: {
          title: 'Finding the ultimate donor',
          details: 'Money moves from an original donor to an international fundraising platform, then to a foreign foundation and finally to an Indian NGO. The NGO should preserve records identifying the original source, intermediary chain, donor agreement and bank references instead of recording only the platform name.',
        },
      },
      {
        title: 'Religious and faith-based activities under the 2026 Rules',
        paragraphs: [
      ...
      {
        title: 'What the FCRA 2.0 portal changes',
        paragraphs: [
      ...
      {
        title: 'The pending 2026 Bill: assets and the Designated Authority',
        paragraphs: [
      ...
      {
        title: 'Common mistakes that create serious risk',
        paragraphs: [
      ...
      {
        title: 'Balanced view: why the changes are debated',
        paragraphs: [
    ...
    faqs: [
      ...
      {
        question: 'When did the FCRA Amendment Rules, 2026 take effect?',
        answer: 'The Rules were notified and came into force on 22 June 2026.',
      },
      {
        question: 'When was the FCRA 2.0 portal launched?',
        answer: 'The Ministry of Home Affairs launched the FCRA 2.0 portal on 30 June 2026.',
      },
      {
      ...
      },
      {
        ...
        answer: 'The 2026 framework generally requires at least Rs 10 lakh of foreign contribution to have been utilised during the preceding two years for renewal. Organisations should check current official instructions and any applicable exception before filing.',
      },
      {
        question: 'What is Form FC-6F?',
        answer: 'Form FC-6F is the transition intimation through which an association registered before the 2026 Rules specifies the purposes and States or Union Territories for which it seeks to retain registration.',
      },
      {
        question: 'Can one NGO transfer foreign contribution to another NGO?',
        answer: 'The post-2020 framework generally prohibits transfer of foreign contribution to another person or NGO as a sub-grant. Genuine purchases of goods or services must be real, properly documented and not used to disguise a grant.',
      },
      {
        question: 'Can an NGO spend foreign contribution in any State in India?',
        answer: 'Under the 2026 Rules, registration is tied to specified States or Union Territories. An organisation should use funds only within its approved purpose and geographical scope or obtain the required modification.',
      },
      {
        question: 'What is an ultimate foreign donor?',
        answer: 'It is the original person or entity that is the real source of the foreign contribution, even when money reaches the Indian organisation through an overseas platform, aggregator, foundation or other intermediary.',
      },
      {
        question: 'Can foreign contribution be used for religious work?',
        answer: 'Certain listed religious and faith-based activities may be permitted, such as maintenance of places of worship, religious education, moral instruction and meditation. Proselytisation is excluded from permitted religious activity under the 2026 Rules.',
      },
      {
        question: 'What happens to foreign-funded assets if registration ends?',
        answer: 'The current Act already contains vesting provisions in specified cases. The pending 2026 Bill proposes a more detailed Designated Authority system for provisional and, later, permanent vesting. The final legal position will depend on the Bill passed by Parliament and the rules made under it.',
      },
      {
